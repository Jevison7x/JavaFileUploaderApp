...
public class CorsFilter implements Filter
{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        try
        {
            ...
            wrappedResponse.setHeader("Access-Control-Allow-Methods", "POST, GET, OPTIONS, DELETE");
            wrappedResponse.setHeader("Access-Control-Max-Age", "3600");
            wrappedResponse.setHeader("Access-Control-Allow-Headers", "x-requested-with");
    ...
    class RequestWrapper extends HttpServletRequestWrapper
    {
        ...
        {
            if(debug)
                System.out.println("CorsFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
        ...
        {
            if(debug)
                System.out.println("CorsFilter::getParameter(" + name + ") localParams = " + localParams);
            if(localParams == null)
        ...
        {
            if(debug)
                System.out.println("CorsFilter::getParameterValues(" + name + ") localParams = " + localParams);
            if(localParams == null)
        ...
        {
            if(debug)
                System.out.println("CorsFilter::getParameterNames() localParams = " + localParams);
            if(localParams == null)
        ...
        {
            if(debug)
                System.out.println("CorsFilter::getParameterMap() localParams = " + localParams);
            if(localParams == null)
